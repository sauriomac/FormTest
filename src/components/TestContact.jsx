    ...
    <div className="form">
      ...
      <div>
        <form className="form_container" onSubmit={handleSubmint}>
          ...
          <h5 className="label" htmlFor="date">Date</h5>
          <input
            id="date"
            className="m1"
            type="date"
          ...
          />
          <h5 className="label" htmlFor="select">Select</h5>
          <select
            id="select"
            name="select"
            value={form.select}
          ...
          <h5 className="label" htmlFor="number">Number</h5>
          <input
            id="number"
            className="m1"
            type="text"
          ...
          <h5 className="label" htmlFor="texta">Lorem ipsum</h5>
          <textarea
            id="textarea"
            ...
            name="texta"
          ></textarea>
          <input id="button" type="submit" className="button" value="Enter"/>
